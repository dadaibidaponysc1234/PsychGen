...
from .views import (StudyListView, StudyDetailView,DisorderStudyCountView, ResearchRegionStudyCountView,BiologicalModalityStudyCountView,
                    GeneticSourceMaterialStudyCountView,YearlyStudyCountView,StudyDeleteView,StudyBulkDeleteView,AutoCompleteSuggestionView, 
                    CountryCollaborationView,CountryListView, DisorderListView, ArticleTypeListView, 
                    BiologicalModalityListView, GeneticSourceMaterialListView,TopFiveDisordersYearlyView,WordCloudView,ShortStudyListView)
# StudyDesignListView,
urlpatterns = [
    path('shortstudies/', ShortStudyListView.as_view(), name='short-study-list'),
